...
<div class="control-group">
  ...
  <div class="controls">
    <input id="orgName" name="orgName" type="text" placeholder="e.g. Tata Consultancy Services Pvt Ltd." class="input-xlarge" required="">
...
<div class="control-group">
  ...
  <div class="controls">
    <input id="orgTitle" name="orgTitle" type="text" placeholder="Your Designation at this company" class="input-xlarge" required="">
...
<td>
  ...
  <div class="controls">                     
        <input id="orgLocation" name="orgLocation" type="text" placeholder="City where you worked" class="input-xlarge" required="">
  </div>
</div>
</td><td></td>    
            </tr>
...
<div class="control-group">
  ...
  <div class="controls">
    <button id="addCompany" name="addCompany" class="btn btn-primary btn-large" onclick="myFunction('Harry Potter','Wizard')">Add More Company+</button>
  </div>
</div>
</td><td>
