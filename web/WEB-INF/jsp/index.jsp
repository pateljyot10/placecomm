  ...
  <body>
            ...
            <div class="nav-collapse collapse">
              <ul class="nav">
                ...
                <ul class="nav pull-right">
                    <li class="active"><a href="#">Welcome,<s:property value="#session.userName" /> </a></li>
              </ul>
            </div><!--/.nav-collapse -->
          </div><!-- /.navbar-inner -->
        </div><!-- /.navbar -->
    ...
    <div class="container marketing">
      ...
      <div class="row">
        <div class="span4">
          <h2>Personal Info</h2>
          <s:a href="viewUserPersonalDtls.action"><img class="img-rounded" src="resources/img/User/personalinfo.png"/></s:a>
        ...
        <div class="span4">
            <h2>Contact Info</h2>  
        <s:a href="viewUserContactDtls.action"><img class="img-rounded" src="resources/img/User/contactinfo.png"/></s:a>
          <p>Edit your contact information such as Contact Number, Email and update your blogs created recently.</p>
          <p><a class="btn" href="#">Edit Here</a></p>
        </div><!-- /.span4 -->
        <div class="span4">
          <h2>Education</h2>
        <s:a href="viewUserEducationDtls.action"><img class="img-rounded" src="resources/img/User/education.png"/></s:a>
      ...
      <div class="row">
        ...
        <div class="span4">
            <h2>Achievements</h2>
        <s:a href="viewUserAchievementDtls.action"><img class="img-rounded" src="resources/img/User/achievement.png"/></s:a>
    ...
    <script src="resources/js/holder/holder.js"></script>
  </body>
</html>
