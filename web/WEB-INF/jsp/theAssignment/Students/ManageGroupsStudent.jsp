...
<div class="container-fluid">
    ...
    <div class="row-fluid">
        <div class="utopia-widget-content">
            ...
            <html:form styleClass="form-horizontal" action="/ManageGroupsStudent.do?callmethod=insertGroup" method="post" styleId="createGroup" >
                    <fieldset>
                        <div class="control-group">
                            <label class="control-label" for="input01" >Group Title</label>

                            <div class="controls">
                                <input id="input01" class="validate[required,maxSize[25]] text-input span5" type="text" name="groupName" placeholder="Give it some name..">
                            </div>
                        </div>
                        ...
                        <div class="control-group">
                            ...
                            <div class="controls">
                                ...
                                <textarea id="textarea" class="validate[required,maxSize[100]] text-area  span5" name="groupDesc"  rows="3" placeholder="It's all about..."></textarea>
    ...
    <div class="row-fluid">
                ...
                <div class="utopia-widget-content" style="display: block;">
                                                ...
                                                <table class="table datatable table-striped table-bordered" id="gdTable">
                                                    ...
                                                    <tbody>
                                                        <logic:iterate id="groupOtherList" name="AssignmentForm" property="groupOtherList">
                                                            <tr>
                                                                <td><bean:write name="groupOtherList" property="assgGroupName" /></td>
                                                                <td><bean:write name="groupOtherList" property="assgGroupDesc" /></td>
                                                            </tr>
                                                        </logic:iterate>
    ...
    <div class="row-fluid">
                <div class="utopia-widget-content" style="display: block;">
                                                ...
                                                <table class="table datatable table-striped table-bordered" id="gdTable">
                                                    ...
                                                    <tbody>
                                                        <logic:iterate id="groupList" name="AssignmentForm" property="groupList">
                                                            <tr>
                                                                
                                                                <td><bean:write name="groupList" property="assgGroupName" /></td>
                                                                <td><bean:write name="groupList" property="assgGroupDesc" /></td>
                                                                <td><html:link page="/ManageGroupsStudent.do?callmethod=deleteGroup" >
                                                                        <html:param  name="groupId">
                                                                            <bean:write name="groupList" property="assgGroupId" />
                                                                        </html:param>
                                                                        Delete</html:link></td>
                                                                <td><html:link page="/ManageGroupsStudent.do?callmethod=editGroup" >
                                                                        <html:param  name="groupId">
                                                                            <bean:write name="groupList" property="assgGroupId" />
                                                                        </html:param>
                                                                        <html:param  name="groupName">
                                                                            <bean:write name="groupList" property="assgGroupName" />
                                                                        </html:param>
                                                                        Edit
                                                                    </html:link>
                                                                </td>
