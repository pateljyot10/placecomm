...
<div class="container-fluid">
    ...
    <div class="row-fluid">
        <div class="utopia-widget-content">
            ...
            <html:form styleClass="form-horizontal" action="/CreateQuizStudent.do?callmethod=updateQuestion" method="post" styleId="createQuestion" >
                <fieldset>
                        ...
                        <div class="control-group">                                                                                 
                            ...
                            <textarea id="textarea" class="validate[required,maxSize[100]] text-area  span12" name="qzQuestion"  rows="3" >  <bean:write name="StudentQuizForm" property="qzQuestion" /> </textarea>
                        </div>
                        <div class="control-group offset1">
                            Reward Points &nbsp;
                        <input id="textarea1" class="validate[required,maxSize[100]" name="qzQuestionMarks"  rows="3" value="<bean:write name="StudentQuizForm" property="qzQuestionMarks" />" /> 
                        </div>
                        <div class="control-group offset1">
                        Penalty Points &nbsp;
                            <input id="textarea1" class="validate[required,maxSize[100]" name="qzNegQuestionMarks"  rows="3" value="<bean:write name="StudentQuizForm" property="qzNegQuestionMarks" />" /> 
                        </div>    
                        </div>
                        <div class="span6">
                        ...
                        <input id="textarea1" class="validate[required,maxSize[100]] text-area " name="qzOption1"  rows="3" value="<bean:write name="StudentQuizForm" property="qzOption1" />" /> &nbsp; Answer Choice 1
                        </div>
                        <div class="control-group offset1">
                        <input type= "radio" name="qzCorrectAnswer" class="validate[required] UploadCheckBox" value="2" checked="false"  /> &nbsp;
                        <input id="textarea2" class="validate[required,maxSize[100]] text-area " name="qzOption2"  rows="3" value="<bean:write name="StudentQuizForm" property="qzOption2" />" /> &nbsp; Answer Choice 2
                        </div>
                        <div class="control-group offset1">
                            <input type= "radio" name="qzCorrectAnswer" class="validate[required] UploadCheckBox" value="3" /> &nbsp;
                        <input id="textarea3" class="validate[required,maxSize[100]] text-area " name="qzOption3"  rows="3" value="<bean:write name="StudentQuizForm" property="qzOption3" />" /> &nbsp; Answer Choice 3
                        </div>
                        <div class="control-group offset1">
                        
                        <input type= "radio" name="qzCorrectAnswer" class="validate[required] UploadCheckBox " value="4"> &nbsp;
                        <input id="textarea4" class="validate[required,maxSize[100]] text-area " name="qzOption4"  rows="3" value="<bean:write name="StudentQuizForm" property="qzOption4" />" />&nbsp;&nbsp; Answer Choice 4
                        </div>
                        </div>
                        ...
                        <div class="control-group">
                            <button id="singlebutton" name="singlebutton" class="btn btn-success span2 offset1">Save</button>
                                &nbsp;
                                <html:link styleClass="btn jumbo"  page="/CreateQuizStudent.do?callmethod=getQuestions">
                         ...
                         <html:hidden property="quizId" write="a" name="StudentQuizForm"  />
                          ...
                          <html:hidden property="qzQuestionId" write="a" name="StudentQuizForm" />
                    </fieldset>
