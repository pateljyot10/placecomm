                    ...
                    <div class="row-fluid">
                        <div class="span12">
                            <section id="formElement" class="utopia-widget utopia-form-box section">
                                ...
                                <div class="utopia-widget-title">
                                    <img src="resources/img/icons/eye(1).png" class="utopia-widget-icon">
                                    <span>Assignments To Be Evaluated</span>
                                </div>
                            ...
                            <tbody>
                                <logic:iterate id="assgMstList" name="EvaluateAssgForm" property="assgMstList">
                                    <tr>
                                        ...
                                        <td><html:link page="/EvaluateAssignment.do?callmethod=download" >
                                            <html:param  name="assgFileUrl">
                                            <bean:write name="assgMstList" property="assgFileUrl" />
                                            </html:param>
                                            Download File
                                            </html:link></td>
                                        <td><html:link page="/EvaluateAssignment.do?callmethod=evaluateAssignment" >
                        ...
                        <div class="utopia-table-action">
                            <div class="btn-group">
                                ...
                                &nbsp;    &nbsp;
                                <a href="http://utopiaadmin.themio.net/dashboard.html#" class="btn jumbo btn-info"><i class="icon-cog"></i> Actions</a>
                                <a href="http://utopiaadmin.themio.net/dashboard.html#" data-toggle="dropdown" class="btn dropdown-toggle"><span 
class="caret"></span></a>
                            ...
                            <section id="formElement" class="utopia-widget utopia-form-box section">
                                ...
                                <div class="utopia-widget-title">
                                    <img src="resources/img/icons/directional_right(1).png" class="utopia-widget-icon">
                                    <span>Evaluated Assignments</span>
                                </div>
                            ...
                            <tbody>
                                <logic:iterate id="assgMstSubmittedList" name="EvaluateAssgForm" property="assgMstSubmittedList">
                                    <tr>
                                        
                                        <td><bean:write name="assgMstSubmittedList" property="assgTitle" /></td>
                                        <td><bean:write name="assgMstSubmittedList" property="assgSubject" /></td>
                                        <td><bean:write name="assgMstSubmittedList" property="assgDetails" /> </td>
                                        <td><bean:write name="assgMstSubmittedList" property="assgSubmitDate" /> </td>
                                        <td><html:link page="/EvaluateAssignment.do?callmethod=exportReport" >
                                            <html:param  name="assgFileUrl">
                                        ...
                                        <td><html:link page="/EvaluateAssignment.do?callmethod=hideAssignment" >
                                            <html:param  name="assgId">
                                        ...
                                        <td><html:link page="/EvaluateAssignment.do?callmethod=exportAssignment" >
                                            <html:param  name="assgId">
                                            <bean:write name="assgMstSubmittedList" property="assgId" />
                                            </html:param>
                                            Report
