...
<div class="container-fluid">
    ...
    <div class="row-fluid">
        <div class="utopia-widget-content">
            ...
            <html:form styleClass="form-horizontal" action="/CreateQuiz.do?callmethod=insertQuestion" method="post" styleId="createQuestion" >
                    <fieldset>
                        ...
                        <div class="control-group">
                                ...
                                &nbsp;
                                <html:link styleClass="btn jumbo"  page="/CreateQuiz.do?callmethod=loadPage">
                          ...
                          <html:hidden property="quizName" write="a" name="QuizForm"  />
                                        ...
                                        <section class="utopia-widget">
                                            <div class="utopia-widget-title">
                                                ...
                                                <span>Question List : <bean:write name="QuizForm" property="quizName" /></span>
                                            </div>
                                            ...
                                            <div class="utopia-widget-content" style="display: block;">
                                                ...
                                                <table class="table datatable table-striped table-bordered" id="gdTable">
                                                    ...
                                                    <tbody>
                                                        <logic:iterate id="questionList" name="QuizForm" property="questionList">
                                                            <tr>
                                                                ...
                                                                <td><html:link page="/CreateQuiz.do?callmethod=QuestionHandler" >
