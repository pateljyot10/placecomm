...
<div class="control-group">
  ...
  <div class="controls">
    <input id="orgName" name="recTitle" type="text" placeholder="e.g. At TCS Pvt Ltd" class="input-xlarge" required="">
...
<div class="control-group">
  ...
  <div class="controls">
    <input id="recBy" name="recBy" type="text" placeholder="The one who recommends you" class="input-xlarge" required="">
...
<td>
  ...
  <div class="controls">                     
        <input id="recLocation" name="recLocation" type="text" placeholder="e.g. at Wipro or Mumbai" class="input-xlarge" required="">
  </div>
</div>
</td><td></td>    
            </tr>
...
<div class="control-group">
  ...
  <div class="controls">                     
    <textarea id="recDesc" name="recDesc"></textarea>
  </div>
</div>
<td><td></td>        </tr>
            <tr>
...
<div class="control-group">
  ...
  <div class="controls">
    <button id="addRec" name="addRec" class="btn btn-primary btn-large" onclick="myFunction('Harry Potter','Wizard')">More Recommendations+</button>
  </div>
</div>
</td>
            <tr>
...
<div class="control-group">
  ...
  <div class="controls">
    <button id="orgSubmit" name="orgSubmit" class="btn btn-inverse btn-large">Save</button>
      ...
      <footer>
          <p class="offset2">CampusLive Initiative by <a href="#">Jyot Patel</a> & <a href="#">Anjana Suvariya</a></p>
      </footer>
                </td><td></td>
</tr>
    </tbody>
