...
<div class="container-fluid">
    ...
    <div class="row-fluid">
        <div class="utopia-widget-content">
            ...
            <html:form styleClass="form-horizontal" action="/CreateQuiz.do?callmethod=insertQuiz" method="post" styleId="createGroup" >
                    <fieldset>
    ...
    <div class="row-fluid">
                <div class="utopia-widget-content" style="display: block;">
                                                ...
                                                <table class="table datatable table-striped table-bordered" id="gdTable">
                                                    ...
                                                    <tbody>
                                                        <logic:iterate id="quizList" name="QuizForm" property="quizList">
                                                            <tr>
                                                                ...
                                                                <td>
                                                                    ...
                                                                    <html:link page="/CreateQuiz.do?callmethod=markComplete" >
                                                                ...
                                                                <td><html:link page="/CreateQuiz.do?callmethod=getQuestions" >
                                                                        <html:param  name="quizId">
                                                                            <bean:write name="quizList" property="id" />
                                                                        </html:param>
