...
<div class="container-fluid">
    ...
    <div class="row-fluid">
        <div class="utopia-widget-content">
            ...
            <html:form styleId="createGroup" styleClass="form-horizontal" action="/ManageGroups.do?callmethod=insertGroup" method="post"  >
                    <fieldset>
                        <div class="control-group">
                            <label class="control-label" for="input01" >Group Title</label>

                            <div class="controls">
                                <input id="input01" class="validate[required,maxSize[25]] span5" type="text" name="groupName" placeholder="Give it some name..">
                            </div>
                        </div>
                        ...
                        <div class="control-group">
                            ...
                            <div class="controls">
                                ...
                                <textarea id="textarea" class="validate[required,maxSize[100]] span5" name="groupDesc"  rows="3" placeholder="It's all about..."></textarea>
                                                    ...
                                                    <tbody>
                                                        <logic:iterate id="groupList" name="AssignmentForm" property="groupList">
                                                            <tr>
                                                                ...
                                                                <td><bean:write name="groupList" property="assgGroupId" /> </td>
                                                                <td><html:link page="/ManageGroups.do?callmethod=deleteGroup" >
                                                                        <html:param  name="groupId">
                                                                            <bean:write name="groupList" property="assgGroupId" />
                                                                        </html:param>
                                                                        <img src="resources/img/icons/trash_can(1).png" class="utopia-widget-icon">
                                                                    </html:link>
                                                                </td>
                                                                
                                                                <td><html:link page="/ManageGroups.do?callmethod=editGroup" >
                                                                        <html:param  name="groupId">
                                                                            <bean:write name="groupList" property="assgGroupId" />
                                                                        </html:param>
