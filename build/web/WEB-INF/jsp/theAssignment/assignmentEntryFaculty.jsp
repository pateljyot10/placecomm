        ...
        <div class="span12">
            ...
            <div class="header-top">
                ...
                <div class="header-wrapper">
                    ...
                    <html:link styleClass="utopia-logo" page="/theAssignment.do"><img src="resources/img/theAssignment/ta_logo.jpg" alt="Utopia"></html:link>
                    ...
                    <div class="span12">
                        ...
                        <div id="snapshot-container" class="noselect"  sorting="category" >
                            ...
                            <div style="border-style: solid;border-color: #888;border-width: 1px;border-left-width: 0px">
                                ...
                                <html:link styleClass="snapshot-link" page="/CreateQuiz.do?callmethod=loadPage">    
                                    ...
                                    <div class="projectFrame">
                                        <h3>
                                            <span class="projectTitle" style="text-align: center">Create Quizzes for Students</span>
                                            		      					      							</h3>
                                    </div>
                                    </html:link>
                            ...
                            <div style="border-style: solid;border-color: #888;border-width: 1px">
                                    ...
                                    <html:link styleClass="snapshot-link" page="/ManageGroups.do?callmethod=getGroupList">    
                                    ...
                                    <div class="projectFrame">
                                        <h3>
                                            <span class="projectTitle" style="text-align: center">Manage Your Groups Here</span>
                                            		      					      							</h3>
                                    </div>
                                    </html:link>
                            ...
                            <div style="border-style: solid;border-color: #888;border-width: 1px;border-left-width: 0px">
                                ...
                                <html:link styleClass="snapshot-link" page="/ManageAssignment.do?callmethod=loadPage">    
                                    ...
                                    <div class="projectFrame">
                                        <h3>
                                            <span class="projectTitle" style="text-align: center">Create & Post Assignments/Projects</span>
                                            		      					      							</h3>
                                    </div>
                                    </html:link>
                            ...
                            <div style="border-style: solid;border-color: #888;border-width: 1px;border-left-width: 0px">
                                ...
                                <html:link styleClass="snapshot-link" page="/EvaluateAssignment.do?callmethod=loadPage">    
                                    ...
                                    <div class="projectFrame">
                                        <h3>
                                            <span class="projectTitle" style="text-align: center">Evaluate the Submitted Assignments</span>
                                            		      					      							</h3>
                                    </div>
                                </html:link>
