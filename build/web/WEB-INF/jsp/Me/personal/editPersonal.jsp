...
<div class="control-group">
  ...
  <div class="controls">
    <input id="studName" name="studName" type="text" placeholder="Student Name goes here" class="input-xlarge" required="">
...
<div class="control-group">
  ...
  <div class="controls">
    <input id="dob" name="dob" type="text" placeholder="When were you born? (dd/mm/yyyy)" class="input-xlarge" required="">
...
<div class="control-group">
  ...
  <div class="controls">
    <div class="input-prepend">
      ...
      <input id="language1" name="language1" class="span2" placeholder="Mostly Spoken" type="text">
    </div>
...
<div class="control-group">
  ...
  <div class="controls">
    <div class="input-prepend">
      ...
      <input id="language2" name="language2" class="span2" placeholder="" type="text">
    </div>
...
<div class="control-group">
  ...
  <div class="controls">                     
    <textarea id="interest" name="interest">Enter Your Multiple Interests Here</textarea>
  </div>
</div>
...
<div class="control-group">
  ...
  <div class="controls">
    <input id="city" name="city" type="text" placeholder="Where are you right now?" class="input-xlarge">
